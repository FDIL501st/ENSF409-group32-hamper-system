...
public class AdultMale extends Person {
     ...
     * @param percentGrain is the percentage of grain calories needed by an adult male
     * @param percentVeggies is the percentage of fruits and veggies calories needed by an adult male
     * @param percentProteins is the percentage of protein calories needed by an adult male
     * @param percentOther is the percentage of other calories needed by an adult male
     * @param Calories is the total number of calories needed by an adult male
